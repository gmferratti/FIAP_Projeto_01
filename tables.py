def extract_table(soup):
  ...
  if tabela_principal:
    ...
    cabecalhos = [th.text.strip() for th in tabela_principal.find('thead').find('tr').find_all('th')]
    ...
    rodape = [td.text.strip() for td in tabela_principal.find('tfoot').find('tr').find_all('td')]
